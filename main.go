...
import (
	...
	"github.com/cyndicatelabs/gobypasser/gobypasser"
)
...
func main() {
	...
	flag.StringVar(&o.FilterResponseCode, "hc", "403", "The response code(s) to hide (e.g. --hc 302 or --hc 404,400).")
	flag.StringVar(&o.FilterResponseSize, "hs", "0", "The response size(s) to hide (e.g. --hs 4096 or --hs 4096,1024).")
